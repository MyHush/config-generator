new Vue({
    ...
    methods: {
        ...
        compile: function () {
          ...
          this.conf =
            "# HUSH Configuaration File<br /><br /># This file has been automatically generated by Hush Config Generator. It may be further cutsomized by hand only.<br /><br /># Creation date: " + compileTime + "<br /><br /># The rpcuser/rpcpassword are used for the local call to hushd. The rpcpassword was randomly set.<br /><br /># Start Hush Configuration<br /><br />daemon=" + this.optionDaemon + "<br />server=" + this.optionServer + "<br />whitelist=" + this.optionWhiteList + "<br />rpcallowip=" + this.optionRpcAllowIp + "<br />rpcuser=" + this.optionRpcUser + "<br />rpcpassword=" + this.optionRpcPassword
